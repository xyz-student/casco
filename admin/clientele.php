...
{ ?>
	<form action="clientele.php" method="post" enctype="multipart/form-data">
	...
	<div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>Edit Clientele</h2>
                <div class="box-icon">
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>Clientele</h2>
            ...
            <div class="box-content">
                <table class="table table-bordered table-striped responsive">
					<tbody>
						...
						<?php 
						$count=1;
						$data=sqlfetch("SELECT * FROM `about` where id='7' order by id");
						...
						<tr>
							...
							<td>
								...
								<a class="ajax-link" href="clientele.php?&pid=<?php echo $menu['id']; ?>&edit=true">
