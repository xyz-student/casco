...
{ ?>
	<form action="warehousing.php" method="post" enctype="multipart/form-data">
...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            <a href="#">Warehousing &amp; Packaging</a>
        </li>
    </ul>
</div>
<?php echo $umessage; ?>
	...
	<div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>Edit Warehousing &amp; Packaging</h2>
                <div class="box-icon">
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>Warehousing &amp; Packaging</h2>
                ...
                <table class="table table-bordered table-striped responsive">
					<tbody>
						...
						<tr>
							...
							<th>Warehousing &amp; Packaging</th>
							
							
						</tr>
						<?php 
						$count=1;
						$data=sqlfetch("SELECT * FROM `about` where id='4' order by id");
						...
						<tr>
							...
							<td>
								...
								<a class="ajax-link" href="warehousing.php?&pid=<?php echo $menu['id']; ?>&edit=true">
