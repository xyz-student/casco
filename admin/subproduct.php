...
if(isset($_POST['addsubproduct']))
{
	...
	{	
		...
		$Filename=date('dmyhis').basename( $_FILES['photo']['name']);		
				...
				$q=$pdo->prepare("INSERT into `subproduct` values(:id,:name, :photo,:des, :fld_order, :actstat, :subcat)");
...
if(isset($_POST['editdone']))
{
	...
	$pdo=getPDOObject();
		...
		WHERE id=?");
				$q->execute(array( $name, $Filename , $des,$fld_order,$actstat, $subcat, $pid));	
				$affected_rows = $q->rowCount();
				if($affected_rows)
					$umessage='<div class="alert alert-success" role="alert">
...
function subproduct_form($pid='0',$name='',$photo='',$des='',$fld_order='0',$actstat='', $subcat='0',$formname='addsubproduct')
{ ?>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Edit subproduct</h2>
                <div class="box-icon">
			...
			{
				extract($subproduct);
				subproduct_form($pid,$name,$photo,$des,$fld_order,$actstat,$subcat,$formname='editdone');
			} ?>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Add subproduct</h2>
                <div class="box-icon">
                    <a href="#" class="btn btn-setting btn-round btn-default"><i
                            class="glyphicon glyphicon-cog"></i></a>
                    <a href="#" class="btn btn-minimize btn-round btn-default"><i
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>subproduct</h2>
