...
{ ?>
	<form action="ourteam.php" method="post" enctype="multipart/form-data">
            ...
            <div class="box-content">
                <table class="table table-bordered table-striped responsive">
					<tbody>
						...
						<?php 
						$count=1;
						$data=sqlfetch("SELECT * FROM `about` where id='5' order by id");
						...
						<tr>
							...
							<td>
								...
								<a class="ajax-link" href="ourteam.php?&pid=<?php echo $menu['id']; ?>&edit=true">
